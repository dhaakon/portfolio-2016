...
About = (function(_super) {
  ...
  About.prototype.VIDEO_PLAYER_ID = "video-player";
  ...
  About.prototype.videos = ['video/loop.mp4', 'video/post_slow.mp4'];
  ...
  About.prototype.createVideo = function() {
    ...
    cb = function() {
      setTimeout((function() {
        console.log(_this.videoJS);
        return _this.videoJS.on('ended', _this.onVideoComplete);
      }), 10);
      return _this.onResize();
    };
    return this.videoJS = videojs(this.VIDEO_PLAYER_ID, videoOptions, cb);
  };
  ...
  About.prototype.onResize = function(e) {
    ...
    return this.sectionContainer.style.marginTop = this.calcYOffset() + "px";
  };
