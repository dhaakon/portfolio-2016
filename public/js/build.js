...
},{"./modules/brush.jsx":5,"jquery":1,"underscore":2}],4:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Bristle = undefined;
...
var Mark = {
  circle: function circle(bristle) {
    var _ctx = bristle.ctx;

    var _y = bristle.y;

    var hb = bristle.heartbeat;
    var _curve = Math.cos(Math.PI / 180 * (hb * 4));

    _curve *= bristle.influence * bristle.dir;

    var _x = _curve / 10 + (bristle.x + hb / bristle.sway);

    var _r = bristle.radius;

    var _s = parseFloat(hb * 8 / _r, 1).toFixed(1);
...
var Bristle = function () {
  function Bristle(ctx, tracker, options) {
    _classCallCheck(this, Bristle);
    ...
    this.radius = (0, _helpers.rand)(430, 440);
...
},{"./helpers.jsx":6}],5:[function(require,module,exports){
'use strict';
...
var _bristle2 = require('./bristle.jsx');
...
var Brush = function () {
  function Brush(ctx) {
    ...
    var _R = 300;
    var _RX = this.ctx.canvas.width / 2;
    var _RY = this.ctx.canvas.height / 2;
  ...
  _createClass(Brush, [{
    ...
    value: function paint() {
      ...
      for (var bristle in this.bristles) {
        var _b = this.bristles[bristle];
    ...
    value: function createBristles() {
      ...
      while (bCount++ < this.numBristles) {
        var _bristle = new _bristle2.Bristle(this.ctx, this.tracker);
        arr.push(_bristle);
      }
...
},{"./bristle.jsx":4,"./helpers.jsx":6}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var rand = function rand(numA, numB) {
  if (!numB) {
    return Math.random() * numA;
  } else {
    var _num = Math.random() * (numB - numA);
